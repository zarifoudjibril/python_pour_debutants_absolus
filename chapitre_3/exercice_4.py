...
# Exercice 5 : Écrivez un programme qui demande à l'utilisateur une température en Celsius, convertit la température en Fahrenheit et imprime la température convertie.
